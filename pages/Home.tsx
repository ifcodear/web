      ...
      <section className="max-w-7xl mx-auto px-6 py-20 lg:py-32 flex flex-col lg:flex-row items-center gap-16">
        <div className="flex-1 space-y-8">
          ...
          <h1 className="text-5xl lg:text-8xl font-black text-white leading-tight tracking-tighter">
            Soluciones de Software <span className="text-primary">Bajo Demanda</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-xl leading-relaxed">
            Diseñamos y desarrollamos plataformas web y aplicaciones, Creamos código limpio, rápido y escalable. Automatización de procesos y soluciones basadas en inteligencia artificial.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            >
              Agenda una auditoría técnica gratuita
